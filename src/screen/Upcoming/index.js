...
import flatListDataUp from '../../components/ProductCareListUp/index';
...
import flatListDataOneUp from '../../components/DiseaseUp/index';
import flatListDataTwoUp from '../../components/OrthocareUp/index';
     ...
     <AppView style={{
       ...
       backgroundColor:"#fff"
        ...
        <AppView style={styles.toptabview}>
          ...
          style={[styles.tapView, {backgroundColor: WHITE_ONE}]}>
            <AppText
              style={[
                styles.defaultText,
                {
