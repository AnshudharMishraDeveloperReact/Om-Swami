...
const BottomSheet = (props) => {
  ...
  let containerStyle = {
    ...
    height: sheetHeight ? sheetHeight : height * 0.4,
    paddingTop: 25,
...
const Indicator = (props) => <ActivityIndicator {...props} />;

const SilentTouchable = (props) => <TouchableWithoutFeedback {...props} />;
const List = (props) => <FlatList {...props} />;
